<template>
  <div class="main-background flex min-h-screen">
    <div class="relative z-10 flex flex-1 flex-col">
      <!-- Top Header with Shop Icon -->
      <header class="relative z-30 flex w-full items-center justify-between p-4 md:p-6">
        ...
        <router-link to="/shop"
          ...
          <ShoppingBagIcon class="h-6 w-6 text-[#6d28d9] transition-all duration-300 group-hover:text-[#8b5cf6]" />
        </router-link>
      </header>

      <!-- Main Content Area -->
      <div class="flex flex-1 w-full items-center justify-center text-white">
        <div class="w-full px-4 pb-20 pt-4 md:pb-8 md:pt-0">
          <router-view />
        </div>
        ...
        <nav
          ...
          <router-link to="/"
            ...
            <HomeIcon class="h-6 w-6 transition-all duration-300 group-hover:scale-110" />
            <span class="mt-1 text-xs text-gray-300/80 font-medium">Home</span>
          </router-link>

          <router-link to="/about"
            class="nav-item-mobile group flex flex-col items-center px-3 py-2 text-[#6d28d9] transition-all duration-300 hover:text-[#8b5cf6] active:scale-95">
            <UserIcon class="h-6 w-6 transition-all duration-300 group-hover:scale-110" />
            <span class="mt-1 text-xs text-gray-300/80 font-medium">About</span>
          </router-link>

          <router-link to="/portfolio"
            class="nav-item-mobile group flex flex-col items-center px-3 py-2 text-[#6d28d9] transition-all duration-300 hover:text-[#8b5cf6] active:scale-95">
            <BriefcaseIcon class="h-6 w-6 transition-all duration-300 group-hover:scale-110" />
            <span class="mt-1 text-xs text-gray-300/80 font-medium">Portfolio</span>
          </router-link>

          <router-link to="/contact"
            class="nav-item-mobile group flex flex-col items-center px-3 py-2 text-[#6d28d9] transition-all duration-300 hover:text-[#8b5cf6] active:scale-95">
            <EnvelopeIcon class="h-6 w-6 transition-all duration-300 group-hover:scale-110" />
            <span class="mt-1 text-xs text-gray-300/80 font-medium">Contact</span>
          </router-link>

          <router-link to="/blog"
            class="nav-item-mobile group flex flex-col items-center px-3 py-2 text-[#6d28d9] transition-all duration-300 hover:text-[#8b5cf6] active:scale-95">
            <ChatBubbleLeftRightIcon class="h-6 w-6 transition-all duration-300 group-hover:scale-110" />
            <span class="mt-1 text-xs text-gray-300/80 font-medium">Blog</span>
          </router-link>
        </nav>
      </div>
    </div>
