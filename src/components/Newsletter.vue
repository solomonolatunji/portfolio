<template>
  <div
    class="newsletter-container relative my-8 rounded-lg bg-gradient-to-r from-purple-700 to-indigo-800 p-6"
  >
    <div class="mx-auto max-w-2xl text-center">
      ...
      <form @submit.prevent="handleSubscribe" class="flex flex-col gap-2 sm:flex-row">
        <input
          ...
          required
          class="w-full rounded-md bg-white/10 px-4 py-2 text-white placeholder-white/70 focus:ring-2 focus:ring-purple-400 focus:outline-none"
        ...
        >
          <svg
            ...
            class="mr-2 h-4 w-4 animate-spin text-purple-800"
