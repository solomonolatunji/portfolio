<template>
  <div
    class="relative h-full overflow-hidden rounded-xl border border-white/5 bg-[#1e1e1e]/70 p-4 shadow-lg backdrop-blur-sm sm:p-6 md:p-8"
  >
    <div
      class="absolute top-0 right-0 h-40 w-40 rounded-full bg-gradient-to-r from-[#6d28d9]/20 blur-2xl"
    ></div>
    <div
      class="absolute bottom-0 left-0 h-40 w-40 rounded-full bg-gradient-to-l from-[#6d28d9]/20 blur-2xl"
    ></div>
    ...
    <form @submit.prevent="submitForm" class="relative z-10 space-y-6">
        ...
        <div class="form-group">
          ...
          <div class="relative">
            <input
              ...
              id="name"
              v-model="form.name"
              class="w-full rounded-xl border-2 border-[#333] bg-[#1a1a1a] px-4 py-3.5 text-sm text-white transition-colors focus:border-[#6d28d9] focus:outline-none"
      ...
      <div class="form-group">
        ...
        <div class="relative">
          <textarea
            ...
            rows="5"
            class="w-full resize-none rounded-xl border-2 border-[#333] bg-[#1a1a1a] px-4 py-3.5 text-sm text-white transition-colors focus:border-[#6d28d9] focus:outline-none"
      ...
      <div class="flex justify-end">
        <button
          type="submit"
          class="flex transform items-center rounded-xl bg-gradient-to-r from-[#6d28d9] to-[#8b5cf6] px-8 py-4 text-base font-medium text-white transition-all duration-300 hover:-translate-y-1 hover:from-[#5b21b6] hover:to-[#7c3aed] hover:shadow-lg hover:shadow-purple-500/20"
