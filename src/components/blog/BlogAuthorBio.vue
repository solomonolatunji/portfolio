<template>
    <div v-if="author"
        ...
        <div class="flex flex-col sm:flex-row items-center sm:items-start gap-6">
            <img :src="author.avatar" :alt="author.name" class="w-24 h-24 rounded-full border-2 border-purple-600">
            <div>
                <h4 class="text-lg font-medium text-white mb-2">{{ author.name }}</h4>
                <p class="text-gray-300 text-sm mb-4">
                    {{ author.bio || `Software developer and technical writer specialized in frontend development with
                    over 5 years of experience building modern web applications using Vue, React, and other cutting-edge
                    technologies.` }}
                </p>
