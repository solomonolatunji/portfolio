    ...
    <div class="mt-8 pt-6 border-t border-[#333]">
        ...
        <div class="flex gap-3">
            <button @click="share('twitter')"
                class="p-2 bg-[#1e1e1e] hover:bg-blue-600 text-white rounded-full transition-colors"
            ...
            <button @click="share('linkedin')"
                class="p-2 bg-[#1e1e1e] hover:bg-blue-900 text-white rounded-full transition-colors"
            ...
            <button @click="share('pinterest')"
                class="p-2 bg-[#1e1e1e] hover:bg-red-600 text-white rounded-full transition-colors"
