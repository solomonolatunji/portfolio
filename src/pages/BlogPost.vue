<template>
    <div class="w-full min-h-screen py-6 md:py-12 pb-12 md:pb-24">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <router-link to="/blog"
                class="inline-flex items-center text-purple-400 hover:text-purple-300 mb-4 sm:mb-8 group transition-colors">
            ...
            <div v-if="post" class="mb-12 sm:mb-16 animate-fadeIn">
                ...
                <div class="mb-8 sm:mb-10">
                    <div class="relative rounded-2xl overflow-hidden shadow-xl max-w-full">
                        <img :src="post.image" :alt="post.title" class="w-full h-auto object-cover max-h-[500px]">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
                    </div>
                </div>

                <div class="prose prose-sm sm:prose lg:prose-lg prose-invert prose-purple max-w-none clear-both">
