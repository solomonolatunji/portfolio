      ...
      <div class="flex flex-col items-center justify-between gap-8 md:flex-row md:gap-12 lg:gap-16">
        ...
        >
          <div class="animate-slideDown">
            <p
              class="mb-3 flex items-center justify-center font-medium tracking-wider text-[#6d28d9] md:justify-start"
            >
            ...
            >
              <span class="role-text mr-3">{{ currentRole }}</span>
          ...
          <!-- Social Links -->
          <div
            class="animate-slideUp flex flex-wrap justify-center gap-3 delay-500 sm:gap-4 md:justify-start md:gap-5"
          >
            <a
              v-for="social in aboutData.socialLinks"
              :key="social.platform"
              :href="social.url"
              target="_blank"
