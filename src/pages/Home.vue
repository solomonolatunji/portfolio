<template>
  <div class="relative w-full pt-16 pb-16 md:pt-52 md:pb-20 lg:pt-64">
    <div class="mx-auto w-full max-w-5xl px-4 sm:px-6 lg:px-8">
      <div class="flex flex-col items-center justify-between gap-8 md:flex-row md:gap-12 lg:gap-16">
        ...
        <div class="flex w-full flex-col items-center text-center md:w-3/5 md:items-start md:text-left">
          ...
          <!-- Social Links -->
          <div
            class="animate-slideUp mb-6 flex flex-wrap justify-center gap-3 delay-500 sm:gap-4 md:justify-start md:gap-5 lg:mb-8">
            <a href="https://github.com/eminisolomon" target="_blank" rel="noopener noreferrer"
              ...
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-[#6d28d9] sm:h-5 sm:w-5" viewBox="0 0 24 24"
                fill="currentColor">
                <path
            ...
            <a href="https://twitter.com/eminisolomon" target="_blank" rel="noopener noreferrer"
            ...
            <a href="https://t.me/eminisolomon" target="_blank" rel="noopener noreferrer" aria-label="Telegram Profile"
              class="social-link flex h-10 w-10 items-center justify-center rounded-full border border-white/5 bg-[#1e1e1e]/70 backdrop-blur-sm transition-all duration-300 hover:-translate-y-2 hover:border-[#6d28d9]/30 hover:bg-[#2d2d2d] sm:h-11 sm:w-11">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-[#6d28d9] sm:h-5 sm:w-5" viewBox="0 0 24 24"
                fill="currentColor">
                <path
            ...
            <a href="https://wa.me/2348130690998" target="_blank" rel="noopener noreferrer"
          ...
          <!-- CTA Buttons -->
          <div class="animate-slideUp flex w-full flex-col gap-3 delay-700 sm:flex-row sm:gap-4">
            <router-link to="/about"
              class="cta-button group inline-flex w-full transform items-center justify-center rounded-lg bg-[#6d28d9] px-6 py-3 text-sm font-medium text-white shadow-lg transition-all duration-300 hover:-translate-y-1 hover:bg-[#5b21b6] hover:shadow-xl hover:shadow-[#6d28d9]/30 sm:w-auto sm:rounded-xl sm:px-8 sm:py-4 sm:text-base md:text-lg">
              ABOUT ME
              <span
                class="ml-2 flex h-5 w-5 items-center justify-center rounded-full bg-white text-xs text-[#6d28d9] transition-transform duration-300 group-hover:translate-x-1 sm:ml-3 sm:h-6 sm:w-6 sm:text-sm">
                →
              </span>
            </router-link>

            <router-link to="/contact"
              class="cta-button group inline-flex w-full items-center justify-center rounded-lg border border-white/10 bg-[#1e1e1e]/70 px-6 py-3 text-sm font-medium text-white shadow-lg backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#6d28d9]/30 hover:bg-[#2d2d2d] hover:shadow-xl sm:w-auto sm:rounded-xl sm:px-8 sm:py-4 sm:text-base md:text-lg">
              <EnvelopeIcon
                class="mr-2 h-4 w-4 text-[#6d28d9] transition-colors duration-300 group-hover:text-[#8b5cf6] sm:h-5 sm:w-5" />
              CONTACT ME
            </router-link>
          </div>
        </div>
