export const experiences = [
  ...
  },
  {
    ...
    description:
      "Built responsive, accessible web applications using modern JavaScript frameworks. Collaborated with UX designers to implement pixel-perfect interfaces. Reduced loading times by 60% through asset optimization and lazy loading techniques.",
  },
];
